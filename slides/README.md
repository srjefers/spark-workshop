...
1. [Apache Spark™ Advanced for Developers Workshop (5 days)](00_agenda-5-days-Apache-Spark-Advanced-for-Developers.html) &mdash; to be taught in [Vilnius, Lithuania](https://en.wikipedia.org/wiki/Vilnius), 13-17 January 2020
...
1. [Multi-Dimensional Aggregation](http://blog.jaceklaskowski.pl/spark-workshop/slides/spark-sql-multi-dimensional-aggregation.html)
