...
4. [Exercise: Working With Files On Hadoop HDFS](spark-exercise-Working-With-Files-On-Hadoop-HDFS.md)
5. [Exercise: Finding bestsellers per category](spark-sql-exercise-Finding-bestsellers-per-category.md)
6. [Exercise: Using Standard Functions (upper)](spark-sql-exercise-Using-Standard-Functions-upper.md)
7. [Exercise: Using explode Standard Function](spark-sql-exercise-Using-explode-Standard-Function.md)
8. [Exercise: Difference in Days Between Dates As Strings](spark-sql-exercise-Difference-in-Days-Between-Dates-As-Strings.md)
9. [Exercise: Using UDFs](spark-sql-exercise-Using-UDFs.md)
10. [Exercise: Finding maximum value (agg)](spark-sql-exercise-Finding-maximum-value-agg.md)
